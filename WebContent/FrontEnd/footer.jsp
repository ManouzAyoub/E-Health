		...
		<div class="container text-center text-md-left">
			<div class="row text-center text-md-left">
				...
				<div class="col-md-5 col-lg-3 col-xl-3 mx-auto mt-3">
					...
					<hr class="mb-4">
					<p>
						<i class="fas fa-home mr-2" style="color: #27AAF0;"></i>21 Avenue elguerssifi, Agadir
					</p>
					<p>
						<i class="fas fa-envelope mr-2" style="color: #27AAF0;"></i>contact@e-health.com
					</p>
					<p>
						<i class="fas fa-mobile mr-2" style="color: #27AAF0;"></i>+212 689182877
					</p>
				</div>
			</div>
			<hr class="mb-4">
				...
				<div>
					<p> Copyright ©2021 All rights reserved by:
						<a href="#" style="text-decoration: none; ">
							<strong class="text-info">E-Health Group</strong>
						</a>
					</p>
				</div>
			</div>
