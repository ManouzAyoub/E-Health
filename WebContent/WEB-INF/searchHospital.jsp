...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="<c:url value="/searchHospital/node_modules/flag-icon-css/css/flag-icon.css"/>">
    <link rel="stylesheet" href="<c:url value="/searchHospital/node_modules/flag-icon-css/css/flag-icon.min.css"/>">
    ...
    <!-- Custom CSS file -->
    <link rel="stylesheet" href="<c:url value="/searchHospital/style.css"></c:url>">
</head>
<body onload="initialize()">
    ...
    <section class="pb-3" id="doctorSearchList">
            ...
            <div class="container py-2">
                <div class="row font-montserrat font-size-20" align="center" style="font-weight: bold;">
                    ...
                    <div class="col-lg-10 input-group">
                        <input id="autocomplete" class="form-control py-2 border-right-0 border" placeholder="Localisation">
        ...
        <div class="container container-fluid">
            <div class="row">
                <div class=" col-6 "><h3 class="container text-left font-gilroy-bold mt-3">Hopitaux</h3></div>
    ...
    <!-- Custom Javascript -->
    <script src="<c:url value="/searchHospital/JSIndex.js"></c:url>"></script>
