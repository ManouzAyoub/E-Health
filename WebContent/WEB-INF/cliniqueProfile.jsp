...
<head>
    <meta charset="utf-8">
    <title>Cliniqie Salam II Agadir</title>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<c:url value="/CliniqueProfile/pageLogo.png"/>"/>

    <!-- Custom CSS file -->
    <link rel="stylesheet" href="<c:url value="/CliniqueProfile/style.css" />">
</head>
<body>
                                ...
                                <div class="col-md-6 font-size-12 font-montserrat d-flex justify-content-center">
                                    <div class="mt-3 font-size-16 font-montserrat font-weight-bold" type="button">
                                        <span class="btn bg-danger rounded px-3 py-1 text-white">
                                            <i class="fas fa-phone-alt"></i>
                                            <span class="weight-bold font-weight-bold">&nbsp; +212${clinique.tel}</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="user-card card-body">
                               <div class="row">
                                   <div class="col-6">
    								...
    								<c:set var="nbrEtoileUser" value="${ ratingImpl.getNumberOfEtoileByUserAndClinique(commentaire.getUser(), commentaire.getClinique()) != null ? ratingImpl.getNumberOfEtoileByUserAndClinique(commentaire.getUser(), commentaire.getClinique()) : Long.valueOf(0) }"></c:set>
    								<c:set var="resultUser" value="${ 5 - nbrEtoileUser }"></c:set>
    ...
    <!-- Custom Javascript -->
    <script src="<c:url value="/CliniqueProfile/JSIndex.js"/>"></script>
